...
# -----------------------------------
  ...
  alias prettyps="~/Scripts/src/system/prettyps.sh"
...
# Google Cloud
# -----------------------------------
  # pass in the number of the node you want to join
  gcssh() {
	gcloud compute ssh node$1
  }


  alias kubletrs-"sudo systemctl daemon-reload && sudo systemctl enable kubelet && sudo systemctl start kubelet && sudo systemctl status kubelet"
  alias kubu-proxytrs-"sudo systemctl daemon-reload && sudo systemctl enable kube-proxy && sudo systemctl start kube-proxy && sudo systemctl status kube-proxy"
